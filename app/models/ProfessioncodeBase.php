<?php
//Generated by buildORM from the cred:Professioncodes

	

	class ProfessioncodeBase extends BaseORM{ //which extends Eloquent...

		var $table = 'Professioncodes';
	...
	}//the end of class Professioncode		
?>