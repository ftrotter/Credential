<?php
//Generated by buildORM from the cred:Phonecoveragecodes

	

	class PhonecoveragecodeBase extends BaseORM{ //which extends Eloquent...

		var $table = 'Phonecoveragecodes';
	...
	}//the end of class Phonecoveragecode		
?>