<?php
//Generated by buildORM from the cred:Licensecodes

	

	class LicensecodeBase extends BaseORM{ //which extends Eloquent...

		var $table = 'Licensecodes';
