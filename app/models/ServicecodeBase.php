<?php
//Generated by buildORM from the cred:Servicecodes

	

	class ServicecodeBase extends BaseORM{ //which extends Eloquent...

		var $table = 'Servicecodes';
